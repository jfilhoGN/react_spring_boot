            ...
            return(
                <Card>
                    <Row>
                        ...
                        <Col s={12} m={12}>
                        <Button onClick={this.handleUpdate(this.state)} className="buttonUpdate btn waves-effect waves-light btn-small grey darken-3" type="submit" name="action">
        ...
        return(
                <Card>
                    <Row>
                        ...
                        <Col s={12} m={12}>
                        <Button onClick={this.handleClickOpen} className="buttonAdd grey darken-3 btn-small" type="submit" name="action">
